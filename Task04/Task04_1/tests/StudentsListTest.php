...
class StudentsListTest extends TestCase
{
    ...
    public function testGet()
    {
        $student = new Student();
        $studentsList = new StudentsList();
        $student -> setName("Svetlana") -> setLastName("Antonova") -> setFaculty("FMiIT") -> setCourse(4) -> setGroup(402);
        $studentsList -> add($student);
    ...
    public function testCurrentAndKey()
    {
        ...
        $studentsList = new StudentsList();
        $student1 -> setName("Svetlana") -> setLastName("Antonova") -> setFaculty("FMiIT")-> setCourse(4) -> setGroup(402);
        $student2 -> setName("Artem") -> setLastName("Wasin") -> setFaculty("MED") -> setCourse(1) -> setGroup(108);
        $student3 -> setName("Ivan") -> setLastName("Retrow") -> setFaculty("ISI") -> setCourse(3) -> setGroup(303);
    ...
    public function testNext(StudentsList $studentsList)
    {
        ...
        "Факультет: MED" . "\n" .
        "Курс: 1" . "\n" .
        "Группа: 108", $studentsList -> current() -> __toString());
        $studentsList -> next();
